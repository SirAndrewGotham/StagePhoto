...
<div>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
            <!-- Tab Navigation - Restored from previous version -->
            <div class="border-b border-gray-200 dark:border-gray-700">
                <div class="flex">
                    <button
                        wire:click="$set('uploadType', 'single')"
                        class="flex-1 px-6 py-4 text-center transition-all {{ $uploadType === 'single' ? 'border-b-2 border-stage-600 text-stage-600' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                        <div class="text-2xl mb-1">📷</div>
                        <div class="font-medium">Single Photo</div>
                        <div class="text-xs opacity-75">Upload one photo with details</div>
                    </button>
                    <button
                        wire:click="$set('uploadType', 'multiple')"
                        class="flex-1 px-6 py-4 text-center transition-all {{ $uploadType === 'multiple' ? 'border-b-2 border-stage-600 text-stage-600' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                        <div class="text-2xl mb-1">📸📸</div>
                        <div class="font-medium">Multiple Photos</div>
                        <div class="text-xs opacity-75">Upload several photos at once</div>
                    </button>
                    <button
                        wire:click="$set('uploadType', 'zip')"
                        class="flex-1 px-6 py-4 text-center transition-all {{ $uploadType === 'zip' ? 'border-b-2 border-stage-600 text-stage-600' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400' }}">
                        <div class="text-2xl mb-1">🗜️</div>
                        <div class="font-medium">ZIP Archive</div>
                        <div class="text-xs opacity-75">Upload a ZIP file with photos</div>
                    </button>
                </div>
            </div>
