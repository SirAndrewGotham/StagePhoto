            ...
            <form wire:submit.prevent="save" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div id="dropzone"
                        ...
                        <p class="text-xs text-gray-500">JPG, PNG, GIF, WebP (max 50MB each)</p>
                    </div>
                    ...
                    @if(count($photos) > 0)
                            ...
                            @foreach($photos as $index => $photo)
                                <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <button type="button" wire:click="removePhoto({{ $index }})" class="text-red-500 hover:text-red-700 p-1 rounded-full hover:bg-red-50 dark:hover:bg-red-900/20">
                        ...
                        <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                            💡 Photos will use filenames as titles. Descriptions can be added later.
                        </div>
                    @endif
                </div>
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove>Upload {{ count($photos) }} Photo(s)</span>
                    <span wire:loading>
                        <svg class="animate-spin h-5 w-5 inline mr-2" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                        Processing {{ count($photos) }} Photo(s)...
                    </span>
                </button>
            </form>
        </div>
