...
new class extends Component {
    #[Title('For Theaters - StagePhoto.ru')]
    public function render()
    {
        $locale = app()->getLocale();

        $contentView = "components.frontend.pages.legal.for-theaters.⚡{$locale}";

        if (!view()->exists($contentView)) {
            $contentView = "components.frontend.pages.legal.for-theaters.⚡ru";
        }

        return view('components.frontend.pages.legal.⚡for-theaters', [
            ...
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center text-white">
                        ...
                        <h1 class="text-4xl font-bold mb-2">@lang('for_theaters')</h1>
                        <p class="text-lg opacity-90">@lang('for_theaters_subtitle')</p>
                    </div>
                </div>
            </div>
