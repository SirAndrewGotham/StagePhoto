...
new class extends Component {
    #[Title('Privacy of Service - StagePhoto.ru')]
    public function render()
    {
        $locale = app()->getLocale();

        // Build the view path for language-specific content
        $contentView = "components.frontend.pages.legal.privacy.⚡{$locale}";

        // Check if the language-specific view exists
        if (!view()->exists($contentView)) {
            // Fallback to Russian
            $contentView = "components.frontend.pages.legal.privacy.⚡ru";
        }

        return view('components.frontend.pages.legal.⚡privacy', [
    ...
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">@lang('terms_of_service')</h1>
